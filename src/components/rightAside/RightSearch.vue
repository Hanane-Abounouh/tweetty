<template>
  <div class="relative text-gray-100 lg:w-3/4 px-2 py-4 pb-2 ">
    ...
    <input type="search" v-model="searchQuery" @input="handleSearch" placeholder="Search Twitter"
      class="bg-blue-900 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow rounded border-0">
